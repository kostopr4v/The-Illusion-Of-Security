...
st.set_page_config(page_title="Тех поддержка",
                   page_icon="main_icon.png",
                   layout="centered")
...
def get_answer(prompt):
    response = requests.post("https://my-subdomen.ru.tuna.am/predict", json={"query": prompt, "history": ""})
...
if prompt := st.chat_input("Ваш вопрос"):
    ...
    echo_response = get_answer(prompt)
